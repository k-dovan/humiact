...
def train_NN_Classifier_with_specific_hyperparams(optimal_model):
...
def do_hyperparam_tuning_in_small_search_space(activation_fn= ('relu', 'sigmoid'),
    ...
    np.save("experiments/NN_hyperparameter-tuning/humiact5_tuning_history_data/detailed_tuning_data.npy",
            detailed_tuning_data)
    # save summary tuning data
    np.save("experiments/NN_hyperparameter-tuning/humiact5_tuning_history_data/summary_tuning_data.npy",
            summary_tuning_data)
...
def plot_hyperparam_configuration_summary_performance(activation_fn,
    ...
    summary_tuning_data = np.load("experiments/NN_hyperparameter-tuning/humiact5_tuning_history_data/summary_tuning_data.npy")
    ...
    pyplot.legend(loc='lower center', bbox_to_anchor=(0.5, -0.25), ncol=4)
...
if __name__ == "__main__":
    print("Starting humiact5 hyperparam-tuning as entry point....")
